...
export default function IntegrantesScreen() {
  ...
  const items = draft?.integrantes ?? [];

  const handleChange = (newItems: CaseContextEntry<FamilyMember>[]) => {
    if (!draft) return;
    void queueSave(caseId, 'integrantes', newItems);
  };
    ...
    >
      ...
      <View style={styles.header}>
        <Text style={styles.title} accessibilityRole="header">
          {t('caseContext.sections.integrantes.title')}
        </Text>
