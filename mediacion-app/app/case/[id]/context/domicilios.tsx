...
export default function DomiciliosScreen() {
  ...
  const items = draft?.domicilios ?? [];

  const handleChange = (newItems: CaseContextEntry<Address>[]) => {
    void queueSave(caseId, 'domicilios', newItems);
  };
    ...
    >
      ...
      <View style={styles.header}>
        <Text style={styles.title} accessibilityRole="header">
          {t('caseContext.sections.domicilios.title')}
        </Text>
