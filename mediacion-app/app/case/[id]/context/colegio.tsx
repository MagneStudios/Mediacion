...
export default function ColegioScreen() {
  ...
  const item = draft?.colegio ?? null;

  const handleChange = (newItem: CaseContextEntry<SchoolInfo> | null) => {
    void queueSave(caseId, 'colegio', newItem as CaseContextEntry<SchoolInfo>);
  };
    ...
    >
      ...
      <View style={styles.header}>
        <Text style={styles.title} accessibilityRole="header">
          {t('caseContext.sections.colegio.title')}
        </Text>
